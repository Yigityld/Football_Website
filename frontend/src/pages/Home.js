                ...
                <div className="bg-gradient-to-br from-yellow-900/60 to-yellow-700/40 rounded-2xl shadow-xl p-8 border border-yellow-400/30 mb-8">
                  ...
                  {showAnalysis && analysisResults && (
                    <div className="grid md:grid-cols-4 gap-8 mt-8">
                        {/* Takım A Analizi */}
                        <div className="bg-neutral-800 rounded-xl border border-neutral-700 shadow-md p-6">
                          <h3 className="text-2xl font-bold text-blue-400 text-center mb-6">{analysisResults.teams.team_a.name} Analizi</h3>
                          <div className="text-neutral-200 text-base font-mono space-y-6 text-center">
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Kaybettiği Maç</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                                {analysisResults.teams.team_a.stats.losses} / 5
                              </span>
                            </div>
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Berabere</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                                {analysisResults.teams.team_a.stats.draws} / 5
                              </span>
                            </div>
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Kazandığı Maç</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                                {analysisResults.teams.team_a.stats.wins} / 5
                              </span>
                            </div>
                            <div className="flex flex-col items-center">
                              <span className="font-bold">2.5 Üst</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                                {analysisResults.teams.team_a.performance_analysis.over_2_5_count} / 5
                              </span>
                            </div>
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Handikaplı Galibiyet</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                                {analysisResults.teams.team_a.performance_analysis.handicap_win_count} / 5
                              </span>
                            </div>
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Karşılıklı Gol</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                        ...
                        {/* Takım B Analizi */}
                        <div className="bg-neutral-800 rounded-xl border border-neutral-700 shadow-md p-6">
                          <h3 className="text-2xl font-bold text-purple-400 text-center mb-6">{analysisResults.teams.team_b.name} Analizi</h3>
                          <div className="text-neutral-200 text-base font-mono space-y-6 text-center">
                            {/* Kaybettiği Maç */}
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Kaybettiği Maç</span>
                        ...
                        <div className="bg-neutral-800 rounded-xl border border-neutral-700 shadow-md p-6">
                          <h3 className="text-2xl font-bold text-amber-400 text-center mb-6">Aralarındaki Maçlar Analizi</h3>
                          <div className="text-neutral-200 text-base font-mono space-y-6 text-center">
                            {/* Karşılıklı Gol */}
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Karşılıklı Gol</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                                ...
                                }).length} / {(analysisResults.head_to_head || []).length}
                              </span>
                            </div>
                        ...
                        {/* Hakem Analizi */}
                        <div className="bg-neutral-800 rounded-xl border border-neutral-700 shadow-md p-6">
                          <h3 className="text-2xl font-bold text-green-400 text-center mb-6">Hakem Analizi</h3>
                          <div className="text-neutral-200 text-base font-mono space-y-6 text-center">
                            {/* Sarı Kart */}
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Maç Başı Sarı Kart</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                            ...
                            {/* Penaltı */}
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Maç Başı Penaltı</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
                            ...
                            {/* Kırmızı Kart */}
                            <div className="flex flex-col items-center">
                              <span className="font-bold">Maç Başı Kırmızı Kart</span>
                              <span className="bg-neutral-700 px-3 py-1 mt-1 rounded-lg font-bold">
